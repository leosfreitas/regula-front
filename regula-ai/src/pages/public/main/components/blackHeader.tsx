    ...
    >
      <div className="flex items-center justify-between max-w-[95%] mx-auto py-6">
        ...
        <Link to="/home" className="flex items-center">
          <img src="RegulaAI_Black.png" alt="Logo" className="w-60 transition-all duration-300" />
        </Link>
        ...
        <div className="hidden md:flex items-center gap-10">
          <nav className="flex items-center gap-10">
            {headerItems.map((item) => (
              <Link
                key={item.href}
                to={item.href}
                className={`text-black font-bold transition-all duration-300 hover:text-gray-300 ${
          ...
          <Link
            to="/auth/select"
            className="ml-10 border-2 border-black/70 text-black font-bold px-7 py-3 rounded-full transition-all duration-300 hover:bg-black/5 hover:border-black text-xl"          >
            Login
          </Link>
        </div>
